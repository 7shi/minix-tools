...
del servers\ipc\srv_ipc.vcproj.*.user
del servers\iso9660fs\srv_iso9660fs.vcproj.*.user
...
rd /s /q "servers\ipc\MINIX Release"
rd /s /q "servers\iso9660fs\MINIX Release"
